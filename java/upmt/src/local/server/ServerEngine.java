...
public abstract class ServerEngine implements SipProviderListener
{
   ...
   /**  
    * UPMT client: this is used by the upmt client for the tunneled messages
    * while in order to send out-of-tunnel messages there is a set of providers in the 
    * associationProviders hash table
    */
