...
public class ServerProfile extends Configure
{
   ...
   /** Array of ProxyingRules based on pairs of username or phone prefix and corresponding nexthop address.
     ...
     * Example: <br>
     * server is responsible for the domain 'zoopera.com' <br>
     * phone_proxying_rules={prefix=0123,nexthop=127.0.0.2:7002} {prefix=*,nexthop=127.0.0.3:7003} <br>
     * a message with recipient 'sip:01234567@zoopera.com' is forwarded to 'sip:01234567@127.0.0.2:7002'
     */
   ...
   /** Array of ProxyingRules based on pairs of destination domain and corresponding nexthop address.
     ...
     * Example: <br>
     * server is responsible for the domain 'zoopera.com' <br>
     * domain_proxying_rules={domain=wonderland.net,nexthop=neverland.net:5060} <br>
     * a message with recipient 'sip:01234567@wonderland.net' is forwarded to 'sip:01234567@neverland.net:5060'
     */
