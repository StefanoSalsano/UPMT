...
import org.zoolu.sip.header.TimestampHeader;
...
public abstract class BaseMessageFactory
{
   ...
   {  Message req=new Message();
      ...
      //se il messaggio è un messaggio di KeepAlive aggiungo l'header Timestamp
      if(body!= null && body.contains("KeepAlive"))
      {	   	  
    	  TimestampHeader ts = new TimestampHeader(String.valueOf(System.currentTimeMillis()));
    	  req.addHeader(ts, false);
      }
   ...
   {  Message resp=new Message();
      ...
      //Se il messaggio di richiesta è un KeepAlive, ricopio nella risposta il timestamp
      
      TimestampHeader tsh = req.getTimestampHeader();
      
      if(tsh != null)
      {   	  
    	  resp.addHeader(tsh, false);
      }
